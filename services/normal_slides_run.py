while True:
    ...
    LLBMA_results_dir = "/media/hdd2/neo/NormalLLBMAResults"
    dzsave_dir = "/media/hdd2/neo/NormalDzsave"
    metadata_path = "/media/hdd2/neo/normal_processing_metadata.csv"
    ...
    normal_slides_names = os.listdir(slides_dir)
    selected_slides = normal_slides_names
