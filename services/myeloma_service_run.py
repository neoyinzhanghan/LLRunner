while True:
    ...
    slide_tracker_path = "/media/hdd3/neo/high_plasma_cell_slides_diff_data.csv"
    ...
    # open the slide_tracker_path
    slide_tracker_df = pd.read_csv(slide_tracker_path)

    # get the accession numbers of the slides that have been processed as a list of strings
    processed_accession_numbers = slide_tracker_df["accession_number"].tolist()
    ...
    print(f"Found a total of {len(selected_slides)} slides.")
    ...
    newer_slides_to_process = [
        slide_name for slide_name in selected_slides if slide_name not in wsi_names
    ]
